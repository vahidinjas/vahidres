...
class KeypointModel(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(2048, 1024, kernel_size=3, stride=1, padding=1, groups=2048)
        self.conv2 = nn.Conv2d(1024, 512, kernel_size=1, stride=1, padding=0)
        self.conv3 = nn.Conv2d(512, 256, kernel_size=3, stride=1, padding=1, groups=512)
        self.conv4 = nn.Conv2d(256, 128, kernel_size=1, stride=1, padding=0)
        self.conv5 = nn.Conv2d(128, 64, kernel_size=3, stride=1, padding=1, groups=128)
        self.fc = nn.Conv2d(64, 11, kernel_size=1, stride=1, padding=0)
