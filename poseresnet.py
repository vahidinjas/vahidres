...
class BottleneckX(nn.Module):
    def __init__(self, num_class):
        ...
        self.base = models.resnext101_32x8d(weights=ResNeXt101_32X8D_Weights)
...
class PoseDepthResNet(nn.Module):
    ...
    def init_weights(self, pretrained=''):
        if True:
            ...
            for m in self.keypoint_layer.modules():
...
def get_pose_depth_net(num_layers, train = True, concat=False,**kwargs):
    ...
    if train:
        ...
        if num_layers == 18:
            ...
            state_dict = torch.hub.load_state_dict_from_url('https://s3.amazonaws.com/pytorch/models/resnet34-333f7ec4.pth')
        elif num_layers == 50:
            state_dict = torch.hub.load_state_dict_from_url('https://s3.amazonaws.com/pytorch/models/resnet50-19c8e357.pth')
        elif num_layers == 101:
            state_dict = torch.hub.load_state_dict_from_url('https://s3.amazonaws.com/pytorch/models/resnet101-5d3b4d8f.pth')
        elif num_layers == 152:
            state_dict = torch.hub.load_state_dict_from_url('https://s3.amazonaws.com/pytorch/models/resnet152-b121ed2d.pth')
        # add this elif statement
        elif num_layers == 101x:
